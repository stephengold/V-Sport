/*
 * vertex shader for the Unshaded/Cameraspace/Monochrome program in V-Sport
 */
#version 450
...
void main() {
    ...
    gl_Position = global.projectionMatrix * geometry.modelMatrix * vec4(vertexPosition_modelspace, 1.0);
}
