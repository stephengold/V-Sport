/*
 * fragment shader for the Phong/Distant/Texture program in V-Sport:
...
void main() {
    ...
    vec4 baseColor = geometry.BaseMaterialColor * texture(ColorMaterialTexture, UV);
    vec3 color = (global.ambientStrength + cosTheta) * baseColor.rgb;
